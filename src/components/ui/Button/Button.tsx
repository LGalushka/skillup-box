...
export const Button = ({
  ...
  const variants = {
    primary:
      'bg-primary hover:bg-primary-hover text-text-light shadow-sm',
    secondary:
      'bg-secondary hover:bg-secondary-hover text-text-primary',
    danger:
      'bg-danger hover:bg-danger-hover text-text-light',
  };
